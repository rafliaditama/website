									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="/siswa/{{$siswa->id}}/{{$mapel->id}}/deletenilai" class="btn btn-danger  btn-sm" onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?')">Delete</a></td>
											</tr>
											@endforeach											
										</tbody>
									</table>
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <form action="/siswa/{{$siswa->id}}/addnilai" method="POST" enctype="multipart/form-data">
				    ...
				    <select name="mapel" class="form-control" id="mapel" name="mapel">
